...
| **NuGet package** | `ElBruno.PersonaPlex.Realtime.SileroVad` |
...
| **NuGet package** | `ElBruno.PersonaPlex.Realtime.Whisper` |
...
| **NuGet package** | `ElBruno.PersonaPlex.Realtime.QwenTTS` |
